...
ON DUPLICATE KEY UPDATE `unit_price` = 900.00;
...
-- 验证查询
-- ============================================
SELECT '外包公司表' AS table_name, COUNT(*) AS count FROM outsource_companies
UNION ALL
...
--   4. value_added_status_configs - 增值管理状态配置表
-- 已插入默认配置数据
