...
class SFExpressService {
    constructor() {
        this.config = null;
        this.mockMode = false; // Mock模式开关
        this.sequenceCounter = 0; // 序列号计数器
        // 顺丰API错误码映射表
        this.ERROR_CODE_MAP = {
            'A1000': '成功',
            'A1001': '参数错误',
     ...
     * 生成MD5签名
     */
    generateSign(msgData, checkWord) {
        const str = msgData + checkWord;
        return crypto_1.default.createHash('md5').update(str, 'utf8').digest('hex').toUpperCase();
    }
    /**
     * 生成请求ID
     ...
     * 根据顺丰丰桥API文档实现
     */
    async request(serviceCode, msgData, config) {
        ...
        try {
            ...
            const response = await axios_1.default.post(cfg.apiUrl, formData.toString(), {
                headers: {
...
exports.default = new SFExpressService();
//# sourceMappingURL=sfExpressService.js.map